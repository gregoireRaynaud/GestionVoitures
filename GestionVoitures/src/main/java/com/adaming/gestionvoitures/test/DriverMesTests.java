...
public class DriverMesTests {
	...
	public static void main(String[] args) throws ParseException {
		...
		Voiture v1 = new Voiture("Punto", "JK5HJK", 2300d, 15000d, "Fiat", "Essence", "bon �tat");
		Voiture v2 = new Voiture("Audi", "5465322", 0d, 20000d, "???", "Essence", "neuf");
		Voiture v3 = new Voiture("Mercedes", "EDRTFG", 500d, 17000d, "???", "Essence", "bon �tat");
		Voiture v4 = new Voiture("Twingo", "UGYHJ", 2000d, 12000d, "???", "Essence", "bon");
		Voiture v5 = new Voiture("Senic", "GY6T7YU", 900d, 14000d, "??", "Essence", "bon �tat");
...
//		
//		try {
//			Reservation r1 = serviceReservation.addReservation(new Reservation(150d, new Date(), d1, d2, 60, "bon �tat"), 5L, 1L);
