...
public class VoitureGetBean implements Serializable{
	...
	@Size(min=7, max=7, message="Veuillez entrer une immatriculation de 7 caract�res")
    private String immatricule;
	@Min(0) 
	@Max(1000000)
	@NotNull(message="Veuillez entrer le kilom�trage")
	...
	@NotNull(message="Veuillez choisir un �tat")
